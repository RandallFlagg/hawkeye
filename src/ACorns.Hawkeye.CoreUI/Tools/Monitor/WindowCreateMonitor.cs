...
//    {
//        internal event CreateWindowHandler WindowCreated;

//        public WindowCreateMonitor()
//        {
//        }
...
//            if ( ApplicationOptions.Instance.HasDynamicExtenders(createdControl.GetType()) )
//            {
//                DynamicExtenderInfo extender = ApplicationOptions.Instance.GetDynamicExtender(createdControl.GetType());
