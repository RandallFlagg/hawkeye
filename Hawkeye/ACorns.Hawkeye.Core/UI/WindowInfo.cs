	...
	public class WindowInfo
	{
		...
		public static void Save(Form form)
		{
			try
			{
				...
				using (StreamWriter fs = new StreamWriter(new FileStream(CoreApplicationOptions.FolderName + "\\" + form.Name + "Window.ini", FileMode.Create)))
				{
		...
		public static bool Load(Form form)
		{
			try
			{
                string fileName = CoreApplicationOptions.FolderName + "\\" + form.Name + "Window.ini";
